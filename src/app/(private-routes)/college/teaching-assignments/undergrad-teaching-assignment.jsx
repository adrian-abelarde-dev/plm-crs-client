...
import EditUndergradTeachingAssignment from './edit-teaching-assigment';

function CollegeUndergradTeachingAssignment() {
      ...
      {facultyInput !== '' ? (
        <>
          ...
          <div className='flex justify-end gap-2'>
            <EditUndergradTeachingAssignment
              subjects={subjects}
...
export default CollegeUndergradTeachingAssignment;
