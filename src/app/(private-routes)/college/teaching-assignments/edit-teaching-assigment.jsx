...
function EditUndergradTeachingAssignment({ subjects, setSubjects }) {
  ...
  const loads = [
    ...
    { label: 'Substitution Load Without Pay (SLW)', loadType: 'SLW' },
  ];
...
export default EditUndergradTeachingAssignment;
