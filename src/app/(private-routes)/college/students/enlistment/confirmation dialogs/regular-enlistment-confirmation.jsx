...
function EnlistmentConfirmationDialogForm({ selectedStudent }) {
    ...
    toast({
      title: (
        <div className='flex flex-row'>
          ...
          <Label>Officially enlisted!</Label>
        </div>
      ),
    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <div className='mt-auto flex justify-center'>
          <Button className='w-[270px]'>Enlist Student</Button>
        </div>
      </AlertDialogTrigger>
...
export default EnlistmentConfirmationDialogForm;
